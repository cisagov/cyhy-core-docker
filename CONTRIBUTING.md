...
issue](https://github.com/cisagov/cyhy-core-docker/issues) in this
...
request](https://github.com/cisagov/cyhy-core-docker/pulls), you will
...
```console
cd cyhy-core-docker
pyenv virtualenv <python_version_to_use> cyhy-core-docker
pyenv local cyhy-core-docker
